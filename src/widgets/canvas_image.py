...
class ImageViewer(ttk.Frame):
    ...
    def get_saved_coords(self) -> tuple[int, int]:
        """ Return saved coords. """
        self.image_canvas.saved_x_coord.set(
            min(self.image_canvas.saved_x_coord.get(), self.image_canvas.im_width))
        self.image_canvas.saved_y_coord.set(
            min(self.image_canvas.saved_y_coord.get(), self.image_canvas.im_height))
